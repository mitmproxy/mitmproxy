...
class TTuple(TObject):
    _stateobject_attributes = dict(x=typing.Tuple[int, Child])


class TList(TObject):
    _stateobject_attributes = dict(x=typing.List[Child])


class TDict(TObject):
    _stateobject_attributes = dict(x=typing.Dict[str, Child])


class TAny(TObject):
    _stateobject_attributes = dict(x=typing.Any)
