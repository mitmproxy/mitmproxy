...
class TestMessage:
    ...
    def test_packing(self):
        ...
        assert invalid_rr_domain_name.answers[0].data == b"\x99live\x06github\x03com\x00"
        ...
        assert valid_compressed_rr_data.answers[0].data == b'\x03ns1\x06google\x03com\x00\tdns-admin\x06google\x03com\x00&~gw\x00\x00\x03\x84\x00\x00\x03\x84\x00\x00\x07\x08\x00\x00\x00<'
