...
@example(
    [
        b"\x00\x00\x00\x01\x07\x00\x00\x00\x01A\x88/\x91\xd3]\x05\\\x87\xa7\x84\x86\x82`\x80f\x80\\\x80"
    ]
)
@example(
    [b"\x00\x00\x05\x02\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00"]
)
@example(
    [
        b"\x00\x00\x13\x01\x04\x00\x00\x00\x01A\x88/\x91\xd3]\x05\\\x87\xa7\x84\x86\x82`\x80f\x80\\\x80"
    ]
)
@example(
    [
        b"\x00\x00\x12\x01\x04\x00\x00\x00\x01\x84\x86\x82`\x80A\x88/\x91\xd3]\x05\\\x87\xa7\\\x81\x07"
    ]
)
@example(
    [
...
@example(
    [
        b"\x00\x00\x14\x01\x04\x00\x00\x00\x01A\x88/\x91\xd3]\x05\\\x87\xa7\x84\x86`\x80\x82f\x80"
    ]
)
@example(
    [
...
@example(
    [
        b"\x00\x00\x03\x01\x04\x00\x00\x00\x01\x84\x86\x82",
