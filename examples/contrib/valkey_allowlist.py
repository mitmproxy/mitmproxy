...
ALLOWLIST_DIR: The directory containing allowlist.txt
...
class Valkey:
    ...
    def configure(self, updates):
        ...
        with open(filepath, 'rt', encoding="utf_8") as f:
            ...
            v.set("allowlist_checksum", hsum)
            # File is open and there's new content. Delete all entries from previous allowlist
            v.delete("allowlist")
    ...
    def request(self, flow: http.HTTPFlow):
        ...
        if not v.sismember("allowlist", domain):
            print(f"Domain {domain} was not found in the allowlist...")
