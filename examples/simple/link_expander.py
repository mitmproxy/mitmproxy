# This script determines if request is an HTML webpage and if so seeks out relative links (<a href="./about.html">) and expands them to absolute links
...
# 			#print('{0} -> {1}'.format(*map))
# 		
# 		flow.response.content = pageText