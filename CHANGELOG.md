...
- Feature: Added option to use Microsoft Windows Certificate Store as a source of trusted CAs for mitmproxy.
  ([#8249](https://github.com/mitmproxy/mitmproxy/pull/8249), @amamarante923)
