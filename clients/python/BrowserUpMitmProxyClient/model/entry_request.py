...
class EntryRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, method, url, http_version, cookies, headers, query_string, headers_size, body_size, *args, **kwargs):  # noqa: E501
        """EntryRequest - a model defined in OpenAPI
