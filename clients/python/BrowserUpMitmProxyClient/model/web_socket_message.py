...
class WebSocketMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, opcode, data, time, *args, **kwargs):  # noqa: E501
        """WebSocketMessage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, opcode, data, time, *args, **kwargs):  # noqa: E501
        """WebSocketMessage - a model defined in OpenAPI
