...
class Har(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, log, *args, **kwargs):  # noqa: E501
        """Har - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, log, *args, **kwargs):  # noqa: E501
        """Har - a model defined in OpenAPI
