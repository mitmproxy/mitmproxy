...
class VerifyResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, name, result, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, name, result, *args, **kwargs):  # noqa: E501
        """VerifyResult - a model defined in OpenAPI
