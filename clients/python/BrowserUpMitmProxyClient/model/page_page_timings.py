...
class PagePageTimings(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PagePageTimings - a model defined in OpenAPI

        Args:

        Keyword Args:
            on_content_load (int): defaults to -1  # noqa: E501
            on_load (int): defaults to -1  # noqa: E501
        ...
        on_content_load = kwargs.get('on_content_load', -1)
        on_load = kwargs.get('on_load', -1)
