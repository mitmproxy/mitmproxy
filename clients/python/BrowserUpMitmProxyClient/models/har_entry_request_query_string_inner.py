...
class HarEntryRequestQueryStringInner(BaseModel):
    ...
    __properties = ["name", "value", "comment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HarEntryRequestQueryStringInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HarEntryRequestQueryStringInner:
