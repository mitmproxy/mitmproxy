...
public class PageTiming {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstPaint, ssl, dns, cumulativeLayoutShift, href, firstInputDelay, onLoad, firstContentfulPaint, domInteractive, onContentLoad, ttfb, largestContentfulPaint);
  }
