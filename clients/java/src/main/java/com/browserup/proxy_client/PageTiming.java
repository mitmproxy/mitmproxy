...
public class PageTiming {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(largestContentfulPaint, firstContentfulPaint, firstInputDelay, onContentLoad, domInteractive, ttfb, href, ssl, dns, cumulativeLayoutShift, onLoad, firstPaint);
  }
