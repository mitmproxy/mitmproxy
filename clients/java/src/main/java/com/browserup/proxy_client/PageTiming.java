...
public class PageTiming {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstInputDelay, dns, onContentLoad, firstContentfulPaint, cumulativeLayoutShift, largestContentfulPaint, domInteractive, href, onLoad, ssl, firstPaint, ttfb);
  }
