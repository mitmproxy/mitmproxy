...
public class PageTiming {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, largestContentfulPaint, firstContentfulPaint, dns, ssl, onContentLoad, ttfb, firstInputDelay, firstPaint, cumulativeLayoutShift, onLoad, domInteractive);
  }
