...
public class PageTiming {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(onContentLoad, onLoad, dns, ttfb, firstContentfulPaint, firstPaint, cumulativeLayoutShift, domInteractive, href, firstInputDelay, ssl, largestContentfulPaint);
  }
