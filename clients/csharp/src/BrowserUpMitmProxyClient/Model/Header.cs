...
namespace BrowserUpMitmProxyClient.Model
{
    ...
    public partial class Header : IEquatable<Header>, IValidatableObject
    {
        ...
        public Header(string name = default(string), string value = default(string), string comment = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Header and cannot be null");
            }
            this.Name = name;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for Header and cannot be null");
            }
            this.Value = value;
