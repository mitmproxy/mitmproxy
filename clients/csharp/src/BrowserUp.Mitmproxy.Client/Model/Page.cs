...
namespace BrowserUp.Mitmproxy.Client.Model
{
    ...
    public partial class Page : Dictionary<String, Object>, IEquatable<Page>, IValidatableObject
    {
        ...
        public Page(DateTime startedDateTime = default(DateTime), string id = default(string), string title = default(string), List<VerifyResult> verifications = default(List<VerifyResult>), List<Counter> counters = default(List<Counter>), List<Error> errors = default(List<Error>), PageTimings pageTimings = default(PageTimings), string comment = default(string)) : base()
        {
        ...
        /// </summary>
        [DataMember(Name = "_counters", EmitDefaultValue = false)]
