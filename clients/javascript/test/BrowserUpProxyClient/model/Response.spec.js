...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.Response();
  });
  ...
  describe('Response', function() {
    it('should create an instance of Response', function() {
      ...
      //var instane = new BrowserUpProxyClient.Response();
      //expect(instance).to.be.a(BrowserUpProxyClient.Response);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new BrowserUpProxyClient.Response();
