...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.Browser();
  });
  ...
  describe('Browser', function() {
    it('should create an instance of Browser', function() {
      ...
      //var instane = new BrowserUpProxyClient.Browser();
      //expect(instance).to.be.a(BrowserUpProxyClient.Browser);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new BrowserUpProxyClient.Browser();
