...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.AfterRequest();
  });
  ...
  describe('AfterRequest', function() {
    it('should create an instance of AfterRequest', function() {
      // uncomment below and update the code to test AfterRequest
      //var instane = new BrowserUpProxyClient.AfterRequest();
      //expect(instance).to.be.a(BrowserUpProxyClient.AfterRequest);
    });
    ...
    it('should have the property expires (base name: "expires")', function() {
      ...
      //var instance = new BrowserUpProxyClient.AfterRequest();
