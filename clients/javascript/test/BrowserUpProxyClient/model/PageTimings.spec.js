...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.PageTimings();
  });
  ...
  describe('PageTimings', function() {
    it('should create an instance of PageTimings', function() {
      ...
      //var instane = new BrowserUpProxyClient.PageTimings();
      //expect(instance).to.be.a(BrowserUpProxyClient.PageTimings);
    });
    ...
    it('should have the property onContentLoad (base name: "onContentLoad")', function() {
      ...
      //var instance = new BrowserUpProxyClient.PageTimings();
