...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.EntryRequestCookies();
  });
  ...
  describe('EntryRequestCookies', function() {
    it('should create an instance of EntryRequestCookies', function() {
      ...
      //var instane = new BrowserUpProxyClient.EntryRequestCookies();
      //expect(instance).to.be.a(BrowserUpProxyClient.EntryRequestCookies);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new BrowserUpProxyClient.EntryRequestCookies();
