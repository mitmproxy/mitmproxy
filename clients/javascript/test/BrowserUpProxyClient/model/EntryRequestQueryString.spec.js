...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.EntryRequestQueryString();
  });
  ...
  describe('EntryRequestQueryString', function() {
    it('should create an instance of EntryRequestQueryString', function() {
      ...
      //var instane = new BrowserUpProxyClient.EntryRequestQueryString();
      //expect(instance).to.be.a(BrowserUpProxyClient.EntryRequestQueryString);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new BrowserUpProxyClient.EntryRequestQueryString();
