...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.PostDatumParams();
  });
  ...
  describe('PostDatumParams', function() {
    it('should create an instance of PostDatumParams', function() {
      // uncomment below and update the code to test PostDatumParams
      //var instane = new BrowserUpProxyClient.PostDatumParams();
      //expect(instance).to.be.a(BrowserUpProxyClient.PostDatumParams);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new BrowserUpProxyClient.PostDatumParams();
