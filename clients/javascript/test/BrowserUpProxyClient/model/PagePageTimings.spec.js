...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpProxyClient.PagePageTimings();
  });
  ...
  describe('PagePageTimings', function() {
    it('should create an instance of PagePageTimings', function() {
      ...
      //var instane = new BrowserUpProxyClient.PagePageTimings();
      //expect(instance).to.be.a(BrowserUpProxyClient.PagePageTimings);
    });
    ...
    it('should have the property onContentLoad (base name: "onContentLoad")', function() {
      ...
      //var instance = new BrowserUpProxyClient.PagePageTimings();
