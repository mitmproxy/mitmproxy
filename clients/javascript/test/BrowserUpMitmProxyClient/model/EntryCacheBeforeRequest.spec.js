...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryCacheBeforeRequest();
  });
  ...
  describe('EntryCacheBeforeRequest', function() {
    it('should create an instance of EntryCacheBeforeRequest', function() {
      // uncomment below and update the code to test EntryCacheBeforeRequest
      //var instance = new BrowserUpMitmProxyClient.EntryCacheBeforeRequest();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryCacheBeforeRequest);
    });
