...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryCache();
  });
  ...
  describe('EntryCache', function() {
    it('should create an instance of EntryCache', function() {
      // uncomment below and update the code to test EntryCache
      //var instance = new BrowserUpMitmProxyClient.EntryCache();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryCache);
    });
