...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryRequestCookiesInner();
  });
  ...
  describe('EntryRequestCookiesInner', function() {
    it('should create an instance of EntryRequestCookiesInner', function() {
      // uncomment below and update the code to test EntryRequestCookiesInner
      //var instance = new BrowserUpMitmProxyClient.EntryRequestCookiesInner();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryRequestCookiesInner);
    });
