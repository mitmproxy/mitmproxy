...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryResponseContent();
  });
  ...
  describe('EntryResponseContent', function() {
    it('should create an instance of EntryResponseContent', function() {
      ...
      //var instane = new BrowserUpMitmProxyClient.EntryResponseContent();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryResponseContent);
    });

    it('should have the property size (base name: "size")', function() {
      // uncomment below and update the code to test the property size
      //var instance = new BrowserUpMitmProxyClient.EntryResponseContent();
