...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryRequest();
  });
  ...
  describe('EntryRequest', function() {
    it('should create an instance of EntryRequest', function() {
      ...
      //var instane = new BrowserUpMitmProxyClient.EntryRequest();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryRequest);
    });

    it('should have the property method (base name: "method")', function() {
      // uncomment below and update the code to test the property method
      //var instance = new BrowserUpMitmProxyClient.EntryRequest();
