...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryResponse();
  });
  ...
  describe('EntryResponse', function() {
    it('should create an instance of EntryResponse', function() {
      ...
      //var instane = new BrowserUpMitmProxyClient.EntryResponse();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryResponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new BrowserUpMitmProxyClient.EntryResponse();
