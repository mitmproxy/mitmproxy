...
(function(root, factory) {
  ...
  describe('PageTiming', function() {
    it('should create an instance of PageTiming', function() {
      ...
      //var instane = new BrowserUpMitmProxyClient.PageTiming();
    ...
    it('should have the property largestContentFullPaint (base name: "_largestContentFullPaint")', function() {
      // uncomment below and update the code to test the property largestContentFullPaint
      //var instance = new BrowserUpMitmProxyClient.PageTiming();
      //expect(instance).to.be();
    });
