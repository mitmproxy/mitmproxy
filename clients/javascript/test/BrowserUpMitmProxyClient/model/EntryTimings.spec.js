...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryTimings();
  });
  ...
  describe('EntryTimings', function() {
    it('should create an instance of EntryTimings', function() {
      ...
      //var instane = new BrowserUpMitmProxyClient.EntryTimings();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryTimings);
    });

    it('should have the property dns (base name: "dns")', function() {
      // uncomment below and update the code to test the property dns
      //var instance = new BrowserUpMitmProxyClient.EntryTimings();
