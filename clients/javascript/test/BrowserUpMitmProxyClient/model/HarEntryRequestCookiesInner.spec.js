...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.HarEntryRequestCookiesInner();
  });
  ...
  describe('HarEntryRequestCookiesInner', function() {
    it('should create an instance of HarEntryRequestCookiesInner', function() {
      // uncomment below and update the code to test HarEntryRequestCookiesInner
      //var instance = new BrowserUpMitmProxyClient.HarEntryRequestCookiesInner();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.HarEntryRequestCookiesInner);
    });
