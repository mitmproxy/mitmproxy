...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryRequestPostData();
  });
  ...
  describe('EntryRequestPostData', function() {
    it('should create an instance of EntryRequestPostData', function() {
      // uncomment below and update the code to test EntryRequestPostData
      //var instance = new BrowserUpMitmProxyClient.EntryRequestPostData();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryRequestPostData);
    });
