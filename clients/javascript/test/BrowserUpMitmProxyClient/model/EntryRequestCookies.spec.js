...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryRequestCookies();
  });
  ...
  describe('EntryRequestCookies', function() {
    it('should create an instance of EntryRequestCookies', function() {
      // uncomment below and update the code to test EntryRequestCookies
      //var instane = new BrowserUpMitmProxyClient.EntryRequestCookies();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryRequestCookies);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new BrowserUpMitmProxyClient.EntryRequestCookies();
