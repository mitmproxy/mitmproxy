...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.EntryCacheBeforeRequestOneOf();
  });
  ...
  describe('EntryCacheBeforeRequestOneOf', function() {
    it('should create an instance of EntryCacheBeforeRequestOneOf', function() {
      // uncomment below and update the code to test EntryCacheBeforeRequestOneOf
      //var instance = new BrowserUpMitmProxyClient.EntryCacheBeforeRequestOneOf();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.EntryCacheBeforeRequestOneOf);
    });
