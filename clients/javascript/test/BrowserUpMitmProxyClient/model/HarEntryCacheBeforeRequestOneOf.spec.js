...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowserUpMitmProxyClient.HarEntryCacheBeforeRequestOneOf();
  });
  ...
  describe('HarEntryCacheBeforeRequestOneOf', function() {
    it('should create an instance of HarEntryCacheBeforeRequestOneOf', function() {
      // uncomment below and update the code to test HarEntryCacheBeforeRequestOneOf
      //var instance = new BrowserUpMitmProxyClient.HarEntryCacheBeforeRequestOneOf();
      //expect(instance).to.be.a(BrowserUpMitmProxyClient.HarEntryCacheBeforeRequestOneOf);
    });
