 ...
 * @module BrowserUpProxyClient/model/WebSocketMessage
 * @version 1.0.0
 */
class WebSocketMessage {
    /**
     * Constructs a new <code>WebSocketMessage</code>.
     * @alias module:BrowserUpProxyClient/model/WebSocketMessage
     * @param type {String} 
     * @param opcode {Number} 
     * @param data {String} 
     * @param time {Number} 
     ...
     * @param {module:BrowserUpProxyClient/model/WebSocketMessage} obj Optional instance to populate.
     * @return {module:BrowserUpProxyClient/model/WebSocketMessage} The populated <code>WebSocketMessage</code> instance.
     */
