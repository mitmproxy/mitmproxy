...
class EntryRequest {
     ...
     * @param queryString {Array.<module:BrowserUpMitmProxyClient/model/EntryRequestQueryString>} 
...
/**
 * @member {Array.<module:BrowserUpMitmProxyClient/model/EntryRequestQueryString>} queryString
 */
