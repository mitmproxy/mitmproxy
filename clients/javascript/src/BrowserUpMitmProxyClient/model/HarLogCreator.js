...
class HarLogCreator {
    ...
    /**
     * Validates the JSON data with respect to <code>HarLogCreator</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HarLogCreator</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HarLogCreator.RequiredProperties) {
            if (!data[property]) {
