...
export default class BrowserUpProxyApi {
    ...
    */
     ...
     * @callback module:BrowserUpMitmProxyClient/browserup-mitmproxy-client/BrowserUpProxyApi~addCounterCallback
     ...
     * @param {module:BrowserUpMitmProxyClient/model/Counter} counter Receives a new counter to add. The counter is stored, under the hood, in an array in the har under the _counters key
     * @param {module:BrowserUpMitmProxyClient/browserup-mitmproxy-client/BrowserUpProxyApi~addCounterCallback} callback The callback function, accepting three arguments: error, data, response
     */
