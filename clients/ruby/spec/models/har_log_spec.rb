...
# Unit tests for BrowserupProxy::HarLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BrowserupProxy::HarLog do
  let(:instance) { BrowserupProxy::HarLog.new }

  describe 'test an instance of HarLog' do
    it 'should create an instance of HarLog' do
      expect(instance).to be_instance_of(BrowserupProxy::HarLog)
    end
  end
