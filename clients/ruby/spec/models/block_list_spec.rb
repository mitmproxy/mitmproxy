...
# Unit tests for BrowserupProxyClient::BlockList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BrowserupProxyClient::BlockList do
  let(:instance) { BrowserupProxyClient::BlockList.new }

  describe 'test an instance of BlockList' do
    it 'should create an instance of BlockList' do
      expect(instance).to be_instance_of(BrowserupProxyClient::BlockList)
    end
  end
