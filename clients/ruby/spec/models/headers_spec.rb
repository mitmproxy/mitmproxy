...
# Unit tests for BrowserupProxy::Headers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BrowserupProxy::Headers do
  let(:instance) { BrowserupProxy::Headers.new }

  describe 'test an instance of Headers' do
    it 'should create an instance of Headers' do
      expect(instance).to be_instance_of(BrowserupProxy::Headers)
    end
  end
