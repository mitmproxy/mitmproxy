...
# Models
require 'browserup_proxy_client/models/counter'
...
require 'browserup_proxy_client/models/entry_timings'
require 'browserup_proxy_client/models/error'
...
require 'browserup_proxy_client/models/web_socket_message'
