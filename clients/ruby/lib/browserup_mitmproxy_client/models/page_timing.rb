...
module BrowserupMitmProxy
  class PageTiming
    ...
    def hash
      [_cumulative_layout_shift, _first_contentful_paint, _largest_contentful_paint, _href, on_load, _dns, _ttfb, _ssl, _first_paint, on_content_load, _dom_interactive, _first_input_delay].hash
    end
