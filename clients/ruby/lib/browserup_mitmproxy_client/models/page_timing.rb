...
module BrowserupMitmProxy
  class PageTiming
    ...
    def hash
      [_href, _largest_contentful_paint, _first_contentful_paint, _dns, _ssl, on_content_load, _ttfb, _first_input_delay, _first_paint, _cumulative_layout_shift, on_load, _dom_interactive].hash
    end
