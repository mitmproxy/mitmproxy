...
module BrowserupMitmProxy
  class PageTiming
    ...
    def hash
      [_largest_contentful_paint, _first_contentful_paint, _first_input_delay, on_content_load, _dom_interactive, _ttfb, _href, _ssl, _dns, _cumulative_layout_shift, on_load, _first_paint].hash
    end
