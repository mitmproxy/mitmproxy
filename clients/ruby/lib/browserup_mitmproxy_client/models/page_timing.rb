...
module BrowserupMitmProxy
  class PageTiming
    ...
    def hash
      [_cumulative_layout_shift, _dom_interactive, _first_contentful_paint, _first_paint, _ssl, _largest_contentful_paint, _href, _dns, _ttfb, on_content_load, _first_input_delay, on_load].hash
    end
