...
module BrowserupMitmProxy
  class PageTiming
    ...
    def hash
      [_first_contentful_paint, on_content_load, _dns, _largest_contentful_paint, _first_paint, _first_input_delay, _ttfb, on_load, _ssl, _href, _cumulative_layout_shift, _dom_interactive].hash
    end
