...
module BrowserupMitmProxy
  class PageTimings
    ...
    def _dns=(_dns)
      if _dns.nil?
        fail ArgumentError, '_dns cannot be nil'
      end
    ...
    def _ssl=(_ssl)
      if _ssl.nil?
        fail ArgumentError, '_ssl cannot be nil'
      end
    ...
    def _time_to_first_byte=(_time_to_first_byte)
      if _time_to_first_byte.nil?
        fail ArgumentError, '_time_to_first_byte cannot be nil'
      end

      if _time_to_first_byte < -1
    ...
    def _cumulative_layout_shift=(_cumulative_layout_shift)
      if _cumulative_layout_shift.nil?
        fail ArgumentError, '_cumulative_layout_shift cannot be nil'
      end

      if _cumulative_layout_shift < -1
    ...
    def _first_paint=(_first_paint)
      if _first_paint.nil?
        fail ArgumentError, '_first_paint cannot be nil'
      end
    ...
    def _first_input_delay=(_first_input_delay)
      if _first_input_delay.nil?
        fail ArgumentError, '_first_input_delay cannot be nil'
      end

      if _first_input_delay < -1
    ...
    def _dom_interactive=(_dom_interactive)
      if _dom_interactive.nil?
        fail ArgumentError, '_dom_interactive cannot be nil'
      end

      if _dom_interactive < -1
    ...
    def _first_contentful_paint=(_first_contentful_paint)
      if _first_contentful_paint.nil?
        fail ArgumentError, '_first_contentful_paint cannot be nil'
      end

      if _first_contentful_paint < -1
