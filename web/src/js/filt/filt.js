...
export default (function () {
    ...
    function peg$parse(input) {
                        ...
                        if (s0 === peg$FAILED) {
                            ...
                            if (s0 === peg$FAILED) {
                                ...
                                if (s0 === peg$FAILED) {
                                    s0 = peg$currPos;
                                    if (
                                        input.substr(peg$currPos, 8) === peg$c41
                                    ) {
                                        s1 = peg$c41;
                                        peg$currPos += 8;
                                    } else {
        ...
        function body(regex) {
            ...
            bodyFilter.desc =
                "body filters are not implemented yet, see https://github.com/mitmproxy/mitmproxy/issues/3609";
            return bodyFilter;
        }
        ...
        function domain(regex) {
            ...
            function domainFilter(flow) {
                return (
                    flow.request &&
                    (regex.test(flow.request.host) ||
                        regex.test(flow.request.pretty_host))
                );
            }
        ...
        function header(regex) {
            ...
            function headerFilter(flow) {
                return (
                    (flow.request &&
                        flowutils.RequestUtils.match_header(
                            flow.request,
                            regex
                        )) ||
                    (flow.response &&
                        flowutils.ResponseUtils.match_header(
                            flow.response,
                            regex
                        ))
                );
        ...
        function requestHeader(regex) {
            ...
            function requestHeaderFilter(flow) {
                return (
                    flow.request &&
                    flowutils.RequestUtils.match_header(flow.request, regex)
                );
            }
        ...
        function responseHeader(regex) {
            ...
            function responseHeaderFilter(flow) {
                return (
                    flow.response &&
                    flowutils.ResponseUtils.match_header(flow.response, regex)
                );
            }
        ...
        function requestContentType(regex) {
            ...
            function requestContentTypeFilter(flow) {
                return (
                    flow.request &&
                    regex.test(
                        flowutils.RequestUtils.getContentType(flow.request)
                    )
                );
            }
            requestContentTypeFilter.desc =
                "req. content type matches " + regex;
        ...
        function responseContentType(regex) {
            ...
            function responseContentTypeFilter(flow) {
                return (
                    flow.response &&
                    regex.test(
                        flowutils.ResponseUtils.getContentType(flow.response)
                    )
                );
            }
            responseContentTypeFilter.desc =
                "resp. content type matches " + regex;
        ...
        function contentType(regex) {
            ...
            function contentTypeFilter(flow) {
                return (
                    ...
                    (flow.response &&
                        regex.test(
                            flowutils.ResponseUtils.getContentType(
                                flow.response
                            )
                        ))
                );
        ...
        function url(regex) {
            ...
            function urlFilter(flow) {
                ...
                return (
                    flow.request &&
                    regex.test(flowutils.RequestUtils.pretty_url(flow.request))
                );
            }
