/**
 * TypeScript declaration file for command.js
 * This file provides type definitions for the command expression parser
 * Generated from PEG.js grammar for mitmproxy command expressions
 */
